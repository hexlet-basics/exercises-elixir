...
Elixir - динамически типизированный язык, поэтому все типы в Elixir проверяются во время выполнения. Тем не менее Elixir поставляется со _спецификациями_, которые представляют собой нотацию, используемую для:
