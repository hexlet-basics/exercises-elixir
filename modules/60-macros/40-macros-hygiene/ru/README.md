...
Так делать можно только в _исключительных_ случаях, будьте крайне осторожны.
...
Есть магическая структура `__ENV__`, которая хранит всю информацию о _скомпилированном_ окружении, включая модули, файлы, переменные, импорты и так далее:
