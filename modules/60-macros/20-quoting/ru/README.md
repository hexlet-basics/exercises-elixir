...
Многие, кто пишут макросы, частно допускают ошибку, забывая передать аргументы функции `unquote`. Важно помнить, что _все_ аргументы передаются макросам во внутреннем формате.
