...
Помимо этого, в конце сигиля можно указать специальный модификатор, который будет влиять на его поведение. Например, если к регулярному выражению добавить модификатор `i`, то регулярное выражение будет _регистронезависимым_:
